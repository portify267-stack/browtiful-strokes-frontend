...
const FloatingWhatsApp = () => {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 sm:bottom-5 sm:right-5 md:bottom-6 md:right-6 z-50 w-12 h-12 xs:w-13 xs:h-13 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-[#25D366] hover:bg-[#20ba59] text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 aspect-square shrink-0"
    ...
    >
      <svg
        ...
        viewBox="0 0 448 512"
        fill="currentColor"
        className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white block"
      >

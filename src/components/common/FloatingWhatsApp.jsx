...
const FloatingWhatsApp = () => {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 w-[56px] h-[56px] sm:w-[60px] sm:h-[60px] md:w-[64px] md:h-[64px] bg-[#25D366] hover:bg-[#20ba59] text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 aspect-square shrink-0"
    ...
    >
      <svg
        ...
        viewBox="0 0 448 512"
        fill="currentColor"
        className="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 text-white block"
      >
